import svgPaths from "./svg-zjhw7qar9m";

function EngineStart() {
  return (
    <div className="h-[27.895px] relative shrink-0 w-[23.242px]" data-name="Engine Start">
...
function Engine() {
  return (
    <div className="absolute bg-[#404253] content-stretch flex flex-col gap-[5px] h-[94.004px] items-center left-0 pb-[9px] pt-[24px] rounded-[11.589px] top-0 w-[79.839px]" data-name="Engine">
      <EngineStart />
...
function Lock1() {
  return (
    <div className="h-[27.894px] relative shrink-0 w-[25.81px]" data-name="Lock">
...
function Lock() {
  return (
    <div className="absolute bg-[#404253] content-stretch flex flex-col gap-[5px] h-[94.004px] items-center left-[88.84px] pb-[9px] pt-[24px] rounded-[11.589px] top-0 w-[79.839px]" data-name="Lock">
      <Lock1 />
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[25.754px] justify-center leading-[0] not-italic relative shrink-0 text-[12.877px] text-[rgba(255,255,255,0.66)] text-center tracking-[-0.3734px] w-[79.839px]">
        <p className="leading-[34.219px]">Lock</p>
      </div>
    </div>
  );
}
...
function Unlock1() {
  return (
    <div className="h-[27.893px] relative shrink-0 w-[25.809px]" data-name="Unlock">
...
function Unlock() {
  return (
    <div className="absolute bg-[#404253] content-stretch flex flex-col gap-[5px] h-[94.004px] items-center left-[177.68px] pb-[9px] pt-[24px] rounded-[11.589px] top-0 w-[79.839px]" data-name="Unlock">
      <Unlock1 />
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[25.754px] justify-center leading-[0] not-italic relative shrink-0 text-[12.877px] text-[rgba(255,255,255,0.66)] text-center tracking-[-0.3734px] w-[79.839px]">
...
function Climate1() {
  return (
    <div className="h-[24.847px] relative shrink-0 w-[26.161px]" data-name="Climate">
...
function Climate() {
  return (
    <div className="absolute bg-[#404253] content-stretch flex flex-col gap-[5.1px] h-[94.004px] items-center left-0 pb-[9px] pt-[27px] rounded-[11.589px] top-[171px] w-[79.839px]" data-name="Climate">
      <Climate1 />
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[25.754px] justify-center leading-[0] not-italic relative shrink-0 text-[12.877px] text-[rgba(255,255,255,0.66)] text-center tracking-[-0.3734px] w-[79.839px]">
        <p className="leading-[34.219px]">Climate</p>
      </div>
    </div>
  );
}
...
function Flash1() {
  return (
    <div className="h-[17.212px] relative shrink-0 w-[24.872px]" data-name="Flash">
...
function Flash() {
  return (
    <div className="absolute bg-[#404253] content-stretch flex flex-col gap-[12.7px] h-[94.004px] items-center left-0 pb-[9px] pt-[27px] rounded-[11.589px] top-[463px] w-[79.839px]" data-name="Flash">
      <Flash1 />
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[25.754px] justify-center leading-[0] not-italic relative shrink-0 text-[12.877px] text-[rgba(255,255,255,0.66)] text-center tracking-[-0.3734px] w-[79.839px]">
        <p className="leading-[34.219px]">Flash</p>
      </div>
    </div>
  );
}
...
function Honk1() {
  return (
    <div className="h-[22.107px] relative shrink-0 w-[24.872px]" data-name="Honk">
...
function Honk() {
  return (
    <div className="absolute bg-[#404253] content-stretch flex flex-col gap-[11px] h-[94.004px] items-center left-[178px] pb-[9px] pt-[24px] rounded-[11.589px] top-[463px] w-[79.839px]" data-name="Honk">
      <Honk1 />
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[25.754px] justify-center leading-[0] not-italic relative shrink-0 text-[12.877px] text-[rgba(255,255,255,0.66)] text-center tracking-[-0.3734px] w-[79.839px]">
        <p className="leading-[34.219px]">Honk</p>
      </div>
    </div>
  );
}
...
function Vent1() {
  return (
    <div className="h-[16.219px] relative shrink-0 w-[41.906px]" data-name="Vent">
...
function Vent() {
  return (
    <div className="absolute bg-[#404253] content-stretch flex flex-col gap-[9.8px] h-[94.004px] items-center left-0 pb-[9px] pt-[31px] rounded-[11.589px] top-[317px]" data-name="Vent">
      <Vent1 />
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[25.754px] justify-center leading-[0] not-italic relative shrink-0 text-[12.877px] text-[rgba(255,255,255,0.66)] text-center tracking-[-0.3734px] w-[79.839px]">
        <p className="leading-[34.219px]">Vent</p>
      </div>
    </div>
  );
}
...
function Defrost1() {
  return (
    <div className="h-[22.935px] relative shrink-0 w-[31.088px]" data-name="Defrost">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 31.0879 22.9353">
        <g id="Defrost">
          <g id="Subtract">
            ...
            <path d={svgPaths.p1c0bf100} fill="url(#paint0_linear_1_101)" mask="url(#path-1-inside-1_1_101)" />
          </g>
          <path d={svgPaths.p22e3d780} fill="var(--stroke-0, #404253)" id="Vector 149" />
          <path d={svgPaths.pa473730} fill="var(--stroke-0, #404253)" id="Vector 150" />
          <path d={svgPaths.p2ea1f070} fill="var(--stroke-0, #404253)" id="Vector 151" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_101" x1="15.5439" x2="15.5439" y1="0" y2="20.0244">
...
function Defrost() {
  return (
    <div className="absolute bg-[#404253] content-stretch flex flex-col gap-[9px] h-[94.004px] items-center left-[266.52px] pb-[9px] pt-[25px] rounded-[11.589px] top-[463px] w-[79.839px]" data-name="Defrost">
      <Defrost1 />
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[25.754px] justify-center leading-[0] not-italic relative shrink-0 text-[12.877px] text-[rgba(255,255,255,0.66)] text-center tracking-[-0.3734px] w-[79.839px]">
        <p className="leading-[34.219px]">Defrost</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[26.537px]">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 26.5367 26.5367">
        <circle cx="13.2684" cy="13.2684" fill="var(--fill-0, #404253)" id="Ellipse 317" r="12.9388" stroke="var(--stroke-0, #404253)" strokeWidth="0.659177" />
      </svg>
      <Group />
    </div>
  );
...
function Add() {
  return (
    <div className="absolute bg-[#28303f] content-stretch flex flex-col h-[94.004px] items-center left-[267px] pb-[9px] pt-[33px] rounded-[11.589px] top-0 w-[79.839px]" data-name="Add">
      <Group4 />
    </div>
  );
}
    ...
    <div className="absolute contents inset-[8.89%_57.2%_11%_0]">
      <div className="absolute flex inset-[8.89%_57.2%_67.78%_0] items-center justify-center" style={{ containerType: "size" }}>
        <div className="-rotate-13 flex-none h-[hypot(4.41357cqw,46.4179cqh)] w-[hypot(95.5864cqw,-53.5821cqh)]">
          <div className="bg-white border-[1.225px] border-solid border-white relative rounded-[6.123px] size-full" />
        </div>
      </div>
...
function FogLight1() {
  return (
    <div className="h-[18.653px] relative shrink-0 w-[24.683px]" data-name="Fog Light">
      <div className="absolute inset-[0_0_8.09%_46.28%]" data-name="Subtract">
...
function FogLight() {
  return (
    <div className="absolute bg-[#404253] content-stretch flex flex-col gap-[12.2px] h-[94.004px] items-center left-[89px] pb-[9px] pt-[26px] rounded-[11.589px] top-[463px] w-[79.839px]" data-name="Fog Light">
      <FogLight1 />
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[25.754px] justify-center leading-[0] not-italic relative shrink-0 text-[12.877px] text-[rgba(255,255,255,0.66)] text-center tracking-[-0.3734px] w-[79.839px]">
        <p className="leading-[34.219px]">Fog Light</p>
      </div>
    </div>
  );
}
...
function Layer() {
  return (
    <div className="absolute inset-[17.66%_6.25%_16.44%_6.78%]" data-name="Layer_1-2">
...
function IconsVehicleSettingsControl() {
  return (
    <div className="overflow-clip relative shrink-0 size-[31.088px]" data-name="Icons/Vehicle Settings & Control">
      <Layer />
    </div>
  );
}
...
function Hood() {
  return (
    <div className="absolute bg-[#404253] content-stretch flex flex-col gap-[3.8px] h-[94.004px] items-center left-[88.84px] pb-[9px] pt-[22px] rounded-[11.589px] top-[317.01px] w-[79.839px]" data-name="Hood">
      <IconsVehicleSettingsControl />
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[25.754px] justify-center leading-[0] not-italic relative shrink-0 text-[12.877px] text-[rgba(255,255,255,0.66)] text-center tracking-[-0.3734px] w-[79.839px]">
        <p className="leading-[34.219px]">Hood</p>
      </div>
    </div>
  );
}
...
function Window1() {
  return (
    <div className="h-[20.207px] relative shrink-0 w-[21.33px]" data-name="Window">
        ...
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22.0294 20.9068">
          <g id="Window">
            <g id="Vector">
              ...
              <path clipRule="evenodd" d={svgPaths.p202b100} fill="#5F606E" fillRule="evenodd" />
...
function Window() {
  return (
    <div className="absolute bg-[#404253] content-stretch flex flex-col gap-[10.7px] h-[94.004px] items-center left-[177.68px] pb-[9px] pt-[26px] rounded-[11.589px] top-[317.01px] w-[79.839px]" data-name="Window">
      <Window1 />
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[25.754px] justify-center leading-[0] not-italic relative shrink-0 text-[12.877px] text-[rgba(255,255,255,0.66)] text-center tracking-[-0.3734px] w-[79.839px]">
        <p className="leading-[34.219px]">Window</p>
      </div>
    </div>
  );
}
...
function Gas() {
  return (
    <div className="h-[27.992px] relative shrink-0 w-[22.219px]" data-name="Gas">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22.2192 27.9922">
        <g id="Group 1000003336">
          ...
          <path d={svgPaths.p26b81880} fill="var(--fill-0, #5F606E)" id="Rectangle 3465076" />
          <rect fill="var(--fill-0, #5F606E)" height="8.39779" id="Rectangle 3465077" rx="0.349908" width="11.8969" x="2.79944" y="2.79972" />
          <path d={svgPaths.p36041700} fill="url(#paint0_linear_1_46)" id="Rectangle 3465078" />
          <path d={svgPaths.p77bd00} fill="url(#paint1_linear_1_46)" id="Rectangle 3465079" />
          <path d={svgPaths.pcebc500} fill="var(--fill-0, #5F606E)" id="Rectangle 3465080" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_46" x1="20.4697" x2="20.4697" y1="0" y2="7.58134">
...
function GasTank() {
  return (
    <div className="absolute bg-[#404253] content-stretch flex flex-col gap-[5.7px] h-[94.004px] items-center left-[266.52px] pb-[9px] pt-[23px] rounded-[11.589px] top-[317.01px] w-[79.839px]" data-name="Gas Tank">
      <Gas />
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[25.754px] justify-center leading-[0] not-italic relative shrink-0 text-[12.877px] text-[rgba(255,255,255,0.66)] text-center tracking-[-0.3734px] w-[79.839px]">
        <p className="leading-[34.219px]">Gas Tank</p>
      </div>
    </div>
  );
}
    ...
    <div className="absolute inset-[0_0_5.18%_0]">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 28.29 28.0004">
        <g id="Group 1308">
          ...
          <path d={svgPaths.p4b3d980} fill="var(--fill-0, #5F606E)" id="Intersect" />
        </g>
      </svg>
    </div>
  );
...
function Heating() {
  return (
    <div className="h-[29.531px] relative shrink-0 w-[28.29px]" data-name="Heating">
      <Group1 />
      <Group2 />
    </div>
  );
...
function Seat() {
  return (
    <div className="absolute bg-[#404253] content-stretch flex flex-col gap-[2.4px] h-[94.004px] items-center left-[88.84px] pb-[9px] pt-[25px] rounded-[11.589px] top-[171.01px] w-[79.839px]" data-name="Seat">
      <Heating />
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[25.754px] justify-center leading-[0] not-italic relative shrink-0 text-[12.877px] text-[rgba(255,255,255,0.66)] text-center tracking-[-0.3734px] w-[79.839px]">
        <p className="leading-[34.219px]">Seat</p>
      </div>
    </div>
  );
}
...
function Ac1() {
  return (
    <div className="h-[27.702px] relative shrink-0 w-[31.286px]" data-name="AC">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 31.2864 27.7022">
        <g id="AC">
          <g id="Group 1306">
            <g id="Subtract">
              ...
              <path d={svgPaths.p24a85980} fill="url(#paint0_linear_1_954)" mask="url(#path-1-inside-1_1_954)" />
            </g>
            <path d={svgPaths.p2b4af800} fill="url(#paint1_linear_1_954)" id="Vector 149" />
            <path d={svgPaths.p1fef2a80} fill="url(#paint2_linear_1_954)" id="Vector 150" />
            <path d={svgPaths.p3ac00a80} fill="url(#paint3_linear_1_954)" id="Vector 151" />
          </g>
        ...
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_954" x1="25.4538" x2="25.4538" y1="1.60156" y2="9.10938">
            <stop stopColor="white" />
            <stop offset="1" stopColor="#575757" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_1_954" x1="23.5241" x2="23.5241" y1="4.78775" y2="10.1974">
            <stop offset="0.341346" stopColor="#404253" />
            <stop offset="1" stopColor="#31648E" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint2_linear_1_954" x1="25.7019" x2="25.7019" y1="4.78775" y2="10.1974">
            <stop offset="0.341346" stopColor="#404253" />
            <stop offset="1" stopColor="#31648E" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint3_linear_1_954" x1="27.9147" x2="27.9147" y1="4.66646" y2="10.0761">
            <stop offset="0.341346" stopColor="#404253" />
            <stop offset="1" stopColor="#31648E" />
          </linearGradient>
        </defs>
...
function Ac() {
  return (
    <div className="absolute bg-[#404253] content-stretch flex flex-col gap-[4.2px] h-[94.004px] items-center left-[177.68px] pb-[9px] pt-[25px] rounded-[11.589px] top-[171.01px] w-[79.839px]" data-name="AC">
      <Ac1 />
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[25.754px] justify-center leading-[0] not-italic relative shrink-0 text-[12.877px] text-[rgba(255,255,255,0.66)] text-center tracking-[-0.3734px] w-[79.839px]">
        <p className="leading-[34.219px]">AC</p>
      </div>
    </div>
  );
}
...
function Wheel() {
  return (
    <div className="h-[31.09px] relative shrink-0 w-[25.448px]" data-name="Wheel">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 25.448 31.0898">
        <g id="Wheel">
          ...
          <path d={svgPaths.p39881a00} fill="var(--fill-0, #404253)" id="Ellipse 223" />
          <path d={svgPaths.pec46d80} fill="var(--fill-0, #404253)" id="Ellipse 224" />
          <path d={svgPaths.p202df190} fill="var(--fill-0, #404253)" id="Ellipse 225" />
...
function Heat() {
  return (
    <div className="absolute bg-[#404253] content-stretch flex flex-col gap-[3.8px] h-[94.004px] items-center left-[266.52px] pb-[9px] pt-[22px] rounded-[11.589px] top-[171.01px] w-[79.839px]" data-name="Heat">
      <Wheel />
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[25.754px] justify-center leading-[0] not-italic relative shrink-0 text-[12.877px] text-[rgba(255,255,255,0.66)] text-center tracking-[-0.3734px] w-[79.839px]">
        <p className="leading-[34.219px]">Heat</p>
      </div>
    </div>
  );
}
...
export default function InactiveState() {
  return (
    <div className="relative size-full" data-name="Inactive State">
      <Engine />
      <Lock />
      <Unlock />
      <Climate />
