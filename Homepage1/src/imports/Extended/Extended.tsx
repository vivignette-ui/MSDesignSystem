import svgPaths from "./svg-8awjd0oxv6";
  ...
  return (
    <div className="absolute h-[12.308px] right-0 top-0 w-[25.875px]" data-name="Elements / Battery">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 25.8754 12.3081">
        <g clipPath="url(#clip0_6_806)" id="Elements / Battery">
...
function Group() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      <div className="col-1 flex items-center justify-center ml-0 mt-0 relative row-1 size-[35.351px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "0" } as React.CSSProperties}>
        <div className="flex-none rotate-135">
          <div className="bg-white relative rounded-[8.62px] size-[24.997px]" />
        </div>
      </div>
    </div>
  );
    ...
    <div className="absolute left-[296.16px] size-[31px] top-[98px]">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 31 31">
        <g id="Group 1000003040">
          <circle cx="15.5" cy="15.5" fill="url(#paint0_linear_6_798)" id="Ellipse 684" r="15.5" />
          <path d={svgPaths.p35e1ac80} fill="var(--fill-0, white)" id="Subtract" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_6_798" x1="15.5" x2="15.5" y1="0" y2="31">
...
export default function Extended() {
  return (
    <div className="relative size-full" data-name="Extended">
      <div className="absolute h-[710px] left-[0.07px] rounded-[44px] top-[251.48px] w-[404px]" style={{ backgroundImage: "linear-gradient(181.01deg, rgb(25, 27, 48) 8.0735%, rgb(31, 41, 55) 43.672%)" }} />
      ...
      <Group3 />
      <button className="absolute block cursor-pointer h-[332.924px] left-0 top-[219px] w-[403.548px]" data-name="Component 84">
        ...
        <div className="absolute inset-[67.08%_8.92%_6.57%_0]">
          <div className="absolute inset-[-4.19%_6.84%_-5.47%_-0.9%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 345.727 96.1877">
              <g filter="url(#filter0_f_6_804)" id="Vector 304">
                <path d={svgPaths.p23e14080} fill="var(--fill-0, black)" />
                <path d={svgPaths.p23e14080} stroke="var(--stroke-0, black)" strokeWidth="0.905725" />
              </g>
              <defs>
                <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="96.1877" id="filter0_f_6_804" width="345.727" x="0" y="-5.96046e-08">
                  <feFlood floodOpacity="0" result="BackgroundImageFix" />
                  <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                  <feGaussianBlur result="effect1_foregroundBlur_6_804" stdDeviation="2.17374" />
                </filter>
              </defs>
            </svg>
          </div>
      ...
      <div className="absolute bg-[rgba(25,27,48,0.55)] h-[60.918px] left-[16.16px] rounded-[51.342px] top-[868px] w-[379.047px]" />
      <Group4 />
      <Group5 />
    </div>
  );
