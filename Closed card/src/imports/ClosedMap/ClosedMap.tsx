import svgPaths from "./svg-zfb2mx7ydm";
...
export default function ClosedMap() {
  return (
    <div className="relative size-full" data-name="Closed map">
      <div className="absolute bg-[rgba(17,24,37,0.35)] h-[153px] left-0 rounded-[13px] top-0 w-[379px]" />
      ...
      <Group1 />
      <div className="absolute bg-[rgba(246,246,246,0.03)] border border-[rgba(65,65,65,0.35)] border-solid h-[66px] left-[13px] rounded-[12.07px] top-[56px] w-[354px]" />
    </div>
  );
}